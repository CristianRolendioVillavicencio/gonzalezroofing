...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $address = trim($_POST["address"]); // Get the address
    ...
    if (empty($full_name) OR empty($message) OR empty($phone) OR empty($address) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    $recipient = "gonzalezimprovement@gmail.com";
...
<body>
    <div class="email-container">
        <div class="header">Congratulations, Gonzalez Roofing And Exteriors LLC Team! 🎨</div>
        <div class="content">
            <p>Hello, $full_name:</p>
            <p>You have received a new potential client. It's time to shine!</p>
...
EMAIL;
    ...
    $email_headers = "From: Gonzalez Roofing And Exteriors LLC <info@gonzalezroofingnc.com>\r\n";
